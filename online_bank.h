...
//void transaction_record1( int transfer, int receiver , char who, unsigned int amount){       //ဒီတခုလုံးလမှာ index_point အသွားအလာကို နားလည်ရင် ဒီ function နားလည်ပြီ
//    //from-WinHtut-to-lonelone-1000
...
//
//            db[transfer].tr_record[space_arrary[transfer]-15].note[index_point]= db[transfer].name[i];
//            index_point++;
//        }
//        for (int a = 0; a < 4; ++ a) {
//            db[transfer].tr_record[space_arrary[transfer]-15].note[index_point]= to[a];
//            index_point++;
//        }
//        for (int aaa = 0; aaa < receiver_name_counter; ++aaa) {
//            db[transfer].tr_record[space_arrary[transfer]-15].note[index_point]= db[receiver].name[aaa];
//            index_point++;
//
//        }
...
//        }
//        for (int i = 0; i < 14; ++i) {
//            db[receiver].tr_record[space_arrary[receiver]-15].note[index_point]=receive[i];
//            index_point++;
//
//        }
//        for (int i = 0; i < transfer_name_counter; ++i) {
//            db[receiver].tr_record[space_arrary[receiver]-15].note[index_point]= db[transfer].name[i];
//            index_point++;
//        }
//         space_arrary[receiver] +=1;
//
